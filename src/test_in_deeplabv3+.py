...
saveFileName = 'test in subset2 tran in deeplabv3+ & outputstride 4 & crossVal TVT & epochs 500 & lr 0.0001 & lrf 0.01 & segment & patchSize R & maskSize circleR 25  & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        model = deeplabv3plus_mobilenet(num_classes=2,output_stride=16,pretrained_backbone=False).cuda(device)
        Dict = torch.load(
            '/home/stu013/mapping/step_3/src/modelParam/MESSIDOR/train in deeplabv3+ & outputstride 16 & VAT 0.5 & crossVal TVT & epochs 500 & lr 0.001 & lrf 0.001 & segment & patchSize R & maskSize circleR 25 & randomDeviation 0.25R & batchsize 16/modelParam_294_6.8059702672966464.pth',
        ...
        with torch.no_grad():
            ...
            real_r8_count,real_r4_count,real_r2_count,real_r_count = computerRrate.computer(pred_site,'./outputFile/MESSIDOR_test_subset2/{}'.format(saveFileName),293,testImgName.reshape(-1))
