import numpy as np
import torch
import dataProcess.testDataProcess_largeCicleMask as DL
...
saveFileName = 'large cicle mask & test in subset2 tran in crossVal TVT & epochs 200 & lr 0.0001 & lrf 0.01 & segment & patchSize R & maskSize circleR 25  & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/modelParam/MESSIDOR/train in large cicle mask & VAT & crossVal TVT & epochs 300 & lr 0.00001 & lrf 0.001 & segment & patchSize R & maskSize circleR 38 & randomDeviation 0.4R & batchsize 16/modelParam_79_7.342215454603727.pth',map_location={'cuda:0':'cuda:1'})
