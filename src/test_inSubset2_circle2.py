...
saveFileName = 'unet_fix & test in subset2 tran in crossVal TVT & epochs 200 & lr 0.0001 & lrf 0.01 & segment & patchSize R & maskSize circleR 25  & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        step2_name = 'unetfix_threshold_R_rate_kernal_test_inSubset2_resnet18Freeze'
        # 使用tensorBoard
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/modelParam/MESSIDOR/train in unetfix & cicleMask inter outer & crossVal TVT & epochs 500 & lr 0.001 & lrf 0.01 & segment & patchSize R & maskSize circleR 30_16 & randomDeviation 0.25R & batchsize 16/modelParam_6_0.33804856292263435.pth',map_location={'cuda:0':'cuda:1'})
        ...
        with torch.no_grad():
            ...
            for i, data in tqdm(enumerate(testDataLoader)):
                val_pred,_ = model(data[0].cuda(device))
