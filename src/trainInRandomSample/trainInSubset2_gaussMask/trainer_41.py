...
saveFileName = 'randomSample & train in subset2 & crossVal TVT & VAT 0.5 & epochs 400 & lr 0.0001 & lrf 0.01 & segment & patchSize R & gauss maskSize 41 & randomDeviation 0.25R & batchsize 16'
class trainer():
