...
saveFileName = 'randomSample & crossVal TVT & VAT 0.5 & epochs 400 & lr 0.0001 & lrf 0.001 & segment & patchSize R & maskSize circleR 19 & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/trainInRandomSample/trainInSubset1/modelParam/MESSIDOR/randomSample & crossVal TVT & VAT 0.5 & epochs 200 & lr 0.0001 & lrf 0.001 & segment & patchSize R & maskSize circleR 21 & randomDeviation 0.25R & batchsize 16/modelParam_101_6.793863292804058.pth')
