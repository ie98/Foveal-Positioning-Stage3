...
saveFileName = '110randomSample & crossVal TVT & not VAT& epochs 300 & lr 0.000001 & lrf 0.001 & segment & patchSize R & maskSize circleR 23 & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/trainInRandomSample/trainInSubset1/modelParam/MESSIDOR/randomSample & crossVal TVT & not VAT& epochs 400 & lr 0.0001 & lrf 0.01 & segment & patchSize R & maskSize circleR 25 & randomDeviation 0.25R & batchsize 16/modelParam_107_7.430676854058002.pth')
