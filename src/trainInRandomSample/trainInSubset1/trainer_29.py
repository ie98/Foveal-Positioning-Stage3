...
saveFileName = 'randomSample & crossVal TVT & epochs 400 & lr 0.0001 & lrf 0.01 & segment & patchSize R & maskSize circleR 29 & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        # Dict = torch.load('/home/stu013/mapping/step_3/src/modelParam/MESSIDOR/best res rebuild crossVal TVT & epochs 200 & lr 0.0001 & lrf 0.001 & segment & patchSize R & maskSize circleR 23 & randomDeviation 0.25R & batchsize 16/modelParam_75_6.277993567825136.pth')
        ...
        # for epoch in range(num_epoch,num_epoch+addEpochs):
            ...
            for i, data in tqdm(enumerate(train_LD)):
                ...
                if epoch > 20:
                    ...
                    batch_loss = main_loss + 0.2 * lds  # 计算 loss （注意 prediction 跟 label 必须同时在 CPU 或是 GPU 上）
                else:
