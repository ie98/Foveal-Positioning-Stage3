...
saveFileName = 'randomSample & crossVal TVT & VAT 0.5 & epochs 400 & lr 0.0001 & lrf 0.01 & segment & patchSize R & maskSize circleR 25 & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/trainInRandomSample/trainInSubset1/modelParam/MESSIDOR/randomSample & crossVal TVT & VAT 0.5& epochs 400 & lr 0.00001 & lrf 0.001 & segment & patchSize R & maskSize circleR 27 & randomDeviation 0.25R & batchsize 16/modelParam_120_8.187372177365335.pth')
