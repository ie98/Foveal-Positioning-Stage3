...
saveFileName = 'randomSample & crossVal TVT & VAT 0.5 & epochs 200 & lr 0.0001 & lrf 0.001 & segment & patchSize R & maskSize circleR 21 & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/trainInRandomSample/trainInSubset1/modelParam/MESSIDOR/randomSample & crossVal TVT & not VAT& epochs 300 & lr 0.000001 & lrf 0.001 & segment & patchSize R & maskSize circleR 23 & randomDeviation 0.25R & batchsize 16/modelParam_80_7.055444032762976.pth')
        ...
        # for epoch in range(num_epoch,num_epoch+addEpochs):
            ...
            for i, data in tqdm(enumerate(train_LD)):
                ...
                if epoch > 5:
                    ...
                    batch_loss = main_loss + 0.8 * lds  # 计算 loss （注意 prediction 跟 label 必须同时在 CPU 或是 GPU 上）
                else:
