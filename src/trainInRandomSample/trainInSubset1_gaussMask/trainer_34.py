...
saveFileName = 'randomSample & crossVal TVT & VAT 0.5 & epochs 400 & lr 0.0001 & lrf 0.01 & segment & patchSize R & gauss maskSize 34 & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/trainInRandomSample/trainInSubset1_gaussMask/modelParam/MESSIDOR/randomSample & crossVal TVT & VAT 0.5 & epochs 400 & lr 0.0001 & lrf 0.01 & segment & patchSize R & gauss maskSize 36 & randomDeviation 0.25R & batchsize 16/modelParam_105_7.025735489783536.pth')
