...
saveFileName = 'randomSample & test in subset2 '
class trainer():
    ...
    def train(self,device):
        step2_name = 'second_randomSample_subset2'
        # 使用tensorBoard
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/trainInRandomSample/trainInSubset1_gaussMask/modelParam/MESSIDOR/randomSample & crossVal TVT & VAT 0.5 & epochs 400 & lr 0.0001 & lrf 0.01 & segment & patchSize R & gauss maskSize 36 & randomDeviation 0.25R & batchsize 16/best_modelParam_25_7.088049464886532.pth',map_location={'cuda:0':'cuda:1'})
        ...
        with torch.no_grad():
            ...
            for i, data in tqdm(enumerate(testDataLoader)):
                ...
                # 模型成绩测试
                print('stage2Count = {}'.format(stage2Count))
