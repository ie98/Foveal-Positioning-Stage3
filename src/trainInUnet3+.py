...
saveFileName = 'Train in Unet3+ & crossVal TVT & epochs 500 & lr 0.001 & lrf 0.001 & segment & patchSize R & maskSize circleR 25 & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/modelParam/MESSIDOR/Train in Unet3+ & crossVal TVT & epochs 500 & lr 0.001 & lrf 0.001 & segment & patchSize R & maskSize circleR 25 & randomDeviation 0.25R & batchsize 16/modelParam_482_6.302475710080416.pth')
