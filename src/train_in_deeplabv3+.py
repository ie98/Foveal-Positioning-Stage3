...
saveFileName = 'train in deeplabv3+ & outputstride 16 & VAT 0.5 & crossVal TVT & epochs 500 & lr 0.001 & lrf 0.001 & segment & patchSize R & maskSize circleR 25 & randomDeviation 0.25R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        # model = deeplabv3plus.modeling.__dict__['deeplabv3plus_mobilenet'](num_classes=2)
        # model = UNet(n_channels=3,n_classes=2).cuda(device)
        #Dict = torch.load('/home/stu013/mapping/step_3/src/modelParam/MESSIDOR/crossVal TVT & epochs 200 & lr 0.0001 & lrf 0.01 & segment & patchSize R & maskSize circleR 23  & randomDeviation 0.25R & batchsize 16/modelParam_137_6.009663329806842.pth')
