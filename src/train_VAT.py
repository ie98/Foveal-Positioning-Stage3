...
saveFileName = 'temp3 & in bestRes crossVal TVT & VAT 0.2 & epochs 300 & lr 0.001 & lrf 0.01 & segment & patchSize R & maskSize circleR 25  & randomDeviation 0.25R & batchsize 16'
class trainer():
