...
def loadImgs(img_name,label,isVal):
    ...
    # if os.path.exists('./data_circle_2/trainImg') is False:
    #     os.makedirs('./data_circle_2/trainImg')
    #
    # if os.path.exists('./data_circle_2/mask') is False:
    #     os.makedirs('./data_circle_2/mask')
    #
    # cv2.imwrite('./data_circle_2/trainImg/{}'.format(img_name),img)
    # cv2.imwrite('./data_circle_2/mask/{}'.format(img_name), img_patch)
