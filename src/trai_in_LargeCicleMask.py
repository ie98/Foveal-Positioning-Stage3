import numpy as np
import torch
import dataProcess.crossVal_circleMask_large as DL
...
saveFileName = 'train in large cicle mask & VAT & crossVal TVT & epochs 300 & lr 0.00001 & lrf 0.001 & segment & patchSize R & maskSize circleR 38 & randomDeviation 0.4R & batchsize 16'
class trainer():
    ...
    def train(self,device):
        ...
        Dict = torch.load('/home/stu013/mapping/step_3/src/modelParam/MESSIDOR/train in large cicle mask & crossVal TVT & epochs 300 & lr 0.0001 & lrf 0.001 & segment & patchSize R & maskSize circleR 38 & randomDeviation 0.45R & batchsize 16/modelParam_44_7.331712218212523.pth')
