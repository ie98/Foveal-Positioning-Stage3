import numpy as np
import torch
import dataProcess.crossVal_cicleMask_dec as DL
...
saveFileName = 'maskSize circleR dec  & randomDeviation 0.25R & batchsize 16'
class trainer():
            ...
            if epoch >= 50:
                ...
                if R_8_per > best_r8 or val_loss < best_valLoss or dist < best_dist or num_epoch - epoch == 50 or num_epoch - epoch == 40 or num_epoch - epoch == 30 or num_epoch - epoch == 20 or num_epoch - epoch == 10 or num_epoch - epoch == 0:
                    ...
                    torch.save(best_model,
                               './modelParam/MESSIDOR/{}/modelParam_{}_{}_{}.pth'.format(saveFileName, epoch, dist,maskSize))
