...
class MyDataSet(Dataset):
    ...
    def __getitem__(self, item):
        ...
        return X_img, Y_label.astype(np.int),new_labels,leftUp_point,label_in_Patch
...
def getDataLoader(batchSize):
    ...
    # 将样本 跨步采样 分成两个样本集合，称为subset1 和 subset2
    ...
    # 从所有样本中，根据 id 获取 训练集 和 验证集 的相应数据
