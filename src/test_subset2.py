...
saveFileName = 'end tset in subset2'
class trainer():
    ...
    def train(self,device):
        step2_name = 'end_test_in_subset2'
        # 使用tensorBoard
        ...
        with torch.no_grad():
            ...
            #     allTime = allTime + time.time() - startTime
            ...
            real_r8_count,real_r4_count,real_r2_count,real_r_count,real_rr_count,real_dist = computerRrate.computer(pred_site,'./outputFile/MESSIDOR_test_subset2/{}'.format(saveFileName),'R_step3_{}'.format(step2_name),testImgName.reshape(-1))
            ...
            print('R_8_per = {},R_4_per = {},R_2_per = {},R_1_per = {},RR_per = {}'.format(R_8_per,R_4_per,R_2_per,R_1_per,RR_per))
            logging.info('R_8_per = {},R_4_per = {},R_2_per = {},R_1_per = {},RR_per = {}'.format(R_8_per,R_4_per,R_2_per,R_1_per,RR_per))
            ...
            dataframe.to_csv('./outputFile/MESSIDOR_test_subset2/{}/stage3_{}.csv'.format(saveFileName,step2_name), sep=',')
